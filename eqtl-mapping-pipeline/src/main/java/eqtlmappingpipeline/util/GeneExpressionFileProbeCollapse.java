 ...
 * @author harmjan
 */
public class GeneExpressionFileProbeCollapse {

    public static void main(String[] args) {

        try {
            GeneExpressionFileProbeCollapse g = new GeneExpressionFileProbeCollapse();
            g.collapseOnGeneName("/Volumes/iSnackHD/Data/GeneticalGenomicsDatasets/BloodHT12/BloodHT12OriginalExpressionData4SNPPCRemoved/ExpressionData.txt.gz.40PCAsOverSamplesRemoved-GeneticVectorsNotRemoved.txt",
                    "/Volumes/iSnackHD/SkyDrive/MetaAnalysisAnnotationFiles/2012-04-23-IlluminaAll96PercentIdentity-ProbeAnnotation-ProbesWithWrongMappingLengthFilteredOut-HT12v3AndEnsemblAnnotation.txt",
                    "/Volumes/iSnackHD/Data/GeneticalGenomicsDatasets/BloodHT12/BloodHT12OriginalExpressionData4SNPPCRemoved/ExpressionData.txt.gz.40PCAsOverSamplesRemoved-GeneticVectorsNotRemoved-EnsemblCollapsed.txt.gz");
//            String[] files = new String[]{
//                "/Volumes/iSnackHD/Data/GeneticalGenomicsDatasets/BloodHT12/BloodHT12OriginalExpressionData4SNPPCRemoved/ExpressionData.txt.gz.40PCAsOverSamplesRemoved-GeneticVectorsNotRemoved.txt-CisEffectsRegressedOut.txt",
//                "/Volumes/iSnackHD/Data/GeneticalGenomicsDatasets/RotterdamStudy/MarjoleinVisit3/ExpressionData/ExpressionData.txt.40PCAsOverSamplesRemoved-GeneticVectorsNotRemoved.txt.gz-CisEffectsRegressedOut.txt",
//                "/Volumes/iSnackHD/Data/GeneticalGenomicsDatasets/BloodH8v2/BloodH8v2OriginalExpressionDataCorrectedFor4GWASPCs/ExpressionData.txt.gz.40PCAsOverSamplesRemoved-GeneticVectorsNotRemoved.txt.gz-CisEffectsRegressedOut.txt"
//            };
//            int[] cols = new int[]{5, 7, 17};
//
//            for (int i = 0; i < files.length; i++) {
//                String infile = files[i];
//                int col = cols[i];
//                String ensemblannot = "/Volumes/Data2/MarjoleinHomeAccount/marjolein/AnnotationFiles/2012-04-23-IlluminaAll96PercentIdentity-ProbeAnnotation-ProbesWithWrongMappingLengthFilteredOut-OnlyEnsemblAnnotation.txt";
//                String probeannot = "/Volumes/Data2/MarjoleinHomeAccount/marjolein/AnnotationFiles/2012-04-23-IlluminaAll96PercentIdentity-ProbeAnnotation-ProbesWithWrongMappingLengthFilteredOut-EnsemblAnnotation-ProbeTranslationTable.txt";
//
//                String pathwayfile = "/Volumes/iSnackHD/PathwayData/2012-06-01-PathwayGMTFiles/reactome/Reactome+.gmt";
////                String pathwayfile = "/Volumes/iSnackHD/PathwayData/2012-06-01-PathwayGMTFiles/go_bp/GO_BP+.gmt";
//                g.collapseProbesBasedOnPathwayAnnotation(infile, ensemblannot, probeannot, pathwayfile, col, "REACTOME", false);
//            }
        } catch (IOException e) {
            e.printStackTrace();
        }
