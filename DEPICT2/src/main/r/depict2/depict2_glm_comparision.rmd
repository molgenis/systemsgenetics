...
# Cene coregulation zscores
coreg.chr1q <- data.frame(fread("~/Desktop/depict2/output/height_paper/debug_files/height_2018_30124842_hg19_51/per_arm/Coregulation_1_q_Enrichment_pathwayScores.tx.gzt", data.table = F), row.names = 1)
