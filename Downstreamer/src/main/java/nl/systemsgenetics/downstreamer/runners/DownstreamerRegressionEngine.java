...
public class DownstreamerRegressionEngine {
    ...
    public static List<LinearRegressionResult> performDownstreamerRegression(DoubleMatrixDataset<String, String> X,
                                                                             ...
                                                                             boolean useJblas, String prefix) throws IOException {
        ...
        return performDownstreamerRegression(X, Y, C, U, L, blockDiagonalIndices, fitIntercept, regressCovariates, useJblas, prefix);
    }
    ...
    public static List<LinearRegressionResult> performDownstreamerRegression(DoubleMatrixDataset<String, String> X,
        ...
        if (XhatCache != null) {
            DoubleMatrixDataset<String, String> tmp = new DoubleMatrixDataset<>(U.getColObjects(), X.getColObjects());
            tmp.setMatrix(XhatCache);
            tmp.save(prefix + "_XHat.txt");
        }
        ...
        for (int curY = 0; curY < Y.columns(); curY++) {
            ...
            bla.add("trait");
            DoubleMatrixDataset<String, String> tmp = new DoubleMatrixDataset<>(U.getColObjects(), bla);
            tmp.setMatrix(YHat);
            tmp.save(prefix + "_YHat.txt");
            ///////////
