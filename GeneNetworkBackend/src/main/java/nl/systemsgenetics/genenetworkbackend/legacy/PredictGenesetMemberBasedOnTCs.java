    ...
    public void predictGenesetMemberBasedOnTCs() {
        ...
        for (int q = 0; q<queryGenesets.length; q++) {
            ...
            if (minNrGenesPerStrata>=10) {
                ...
                double[] zScoreProfile = new double[dataset.nrSamples];
                for (int s=0; s<nrStrata; s++) {
                    ...
                    for (int tc=0; tc<nrTCsPerStrata[s]; tc++) {
                        ...
                        System.out.println(dataset.sampleNames[tc + strataStartColumn[s]] + "\t" + (tc + strataStartColumn[s]) + "\t" + nrGenesInGenesetPerStrata[s] + "\t" + t + "\t" + zScore + "\t" + pValue + "\t" + df);
                    }
                }
                ...
                for (int p=0; p<dataset.nrProbes; p++) {
                    ...
                    if (datasetGeneset.rawData[p][geneset]==1) {
                        ...
                        zScoreProfileToUse = new double[dataset.nrSamples];
