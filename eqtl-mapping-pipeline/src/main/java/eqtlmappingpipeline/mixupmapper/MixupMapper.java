...
public class MixupMapper extends MetaQTL3 {
	...
	public void run(String xmlSettingsFile, String texttoreplace, String texttoreplacewith,
		...
		run(xmlSettingsFile, texttoreplace, texttoreplacewith, ingt, inexp, inexpplatform, inexpannot,
				gte, out, cis, trans, perm, textout, binout, snpfile, threads, maxNrResults, regressouteqtls, snpprobecombofile, inputeQTLs, testall, 10000);
	}

	public void run(String xmlSettingsFile, String texttoreplace, String texttoreplacewith,
					String ingt, String inexp, String inexpplatform, String inexpannot,
					String gte, String out, boolean cis, boolean trans, int perm, boolean textout, boolean binout, String snpfile, Integer threads, Integer maxNrResults,
					String regressouteqtls, String snpprobecombofile, String inputeQTLs, boolean testall, Integer variantbuffer) throws IOException, Exception {
		...
		if (inputeQTLs == null) {
			...
			if (snpfile != null) {
				...
				m_settings.numberOfVariantsToBuffer = variantbuffer;
			}
...
//                    System.out.println(trInds[i] + "\t" + genotypeSampleIndex + "\t" + genotypeSample);
		...
		SNPLoader loader = genotypeData.createSNPLoader(100);
