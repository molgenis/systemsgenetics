 ...
 */
package eqtlmappingpipeline.trityperconverter.Genotype;
...
public class MachImputedToTriTyper {
    ...
    public MachImputedToTriTyper(String dir, String outputDir) throws IOException {
        ...
        BufferedWriter outSNPs = new java.io.BufferedWriter(new FileWriter(outputDir + "/SNPs.txt"));
        ...
        BufferedWriter outInds = new java.io.BufferedWriter(new FileWriter(outputDir + "/Individuals.txt"));
        ...
        System.out.println("\n\n\n");
        System.out.println("MACH Imputed data has been imported, now conducting quality control.");
        System.out.println("\n\n\n");
