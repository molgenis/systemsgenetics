...
//            String outputFile = args[2];
        ...
        if (refGen != null && interestStrings != null) {
            try {
                writeFastaIncDirectionGuessing(refGen, interestStrings, outputFile);
...
//            System.out.println(str);
    ...
    private static void writeFastaIncDirectionGuessing(ReferenceGenomeFasta refGen, HashMap<String, HashMap<String, Triple<String, Integer, Integer>>> interestStrings, String outputFile) throws IOException {
