...
class GenotypeHarmonizer {
    ...
    static {
        ...
        option = OptionBuilder.withArgName("double")
                .hasArg()
                .withDescription("The minimum minor allelel frequency to include SNP in the output data \n")
        ...
        option = OptionBuilder.withArgName("double")
                .hasArg()
                .withDescription("The minimum call rate to include SNP in the output data \n")
        ...
        option = OptionBuilder.withArgName("double")
                .hasArg()
                .withDescription("The minimum hardy weinberg equilibrium p value to include SNP in the output data \n")
        ...
        option = OptionBuilder.withArgName("string")
                .hasArg()
                .withDescription("Selection of chromosome for the output file \n")
        ...
        option = OptionBuilder.withArgName("string")
                .hasArg()
                .withDescription("The location of variant filter list \n")
        ...
        option = OptionBuilder.withArgName("string")
                .hasArg()
                .withDescription("The location of sample filter list \n")
        ...
        if ((minCallRate != 0.0F) || (minMAF != 0.0F) || (minHwePvalue != 0.0D) || (variantFilterListFile != null) || (seqFilterIn != null)) {
            ...
            if (variantFilterListFile != null) {
                try {
                    ...
                    java.util.logging.Logger.getLogger(GenotypeHarmonizer.class.getName()).log(java.util.logging.Level.SEVERE, null, e);
                }
            }
