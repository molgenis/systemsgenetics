    ...
    public eQTLFoldChangeCalculatorGUI(String[] args) {
        ...
        try {
            if (settingsfile == null && in == null) {
                ...
                m.initialize(settingsfile, settingstexttoreplace, settingstexttoreplacewith, null, null, in, inexp, inexpplatform, inexpannot, gte, out, cis, trans, perm, textout, binout, snpfile, threads, null, null, null);
