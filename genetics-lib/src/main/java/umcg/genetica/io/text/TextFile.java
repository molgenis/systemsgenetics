...
//        System.out.println("Closing "+loc);
    ...
    /**
     * This method is a wrapper for readLineElemsReturnReference: this method returns default substrings delimited by Pattern p.
     * @param p The Pattern object to split with (e.g. TextFile.tab or Strings.comma)
     ...
     * As such, this method may be more memory-efficient in some situations (for example when only a multiple columns should be loaded and stored in memory).
     * @param p The Pattern object to split with (e.g. TextFile.tab or Strings.comma)
     * @return New String objects for each substring delimited by Pattern p
     * @throws IOException 
     */
    ...
    /**
     * This method returns a new object for each of the splitted elements, instead of the default action, in which each substring is backed by the original full-length String. 
     * As such, this method may be more memory-efficient in some situations (for example when only a single column should be loaded and stored in memory).
     * @param p The Pattern object to split with (e.g. TextFile.tab or Strings.comma)
     * @return New String objects for each substring delimited by Pattern p
     * @throws IOException 
     */
