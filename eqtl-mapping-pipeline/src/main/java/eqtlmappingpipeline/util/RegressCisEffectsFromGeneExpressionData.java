    ...
    public RegressCisEffectsFromGeneExpressionData(String[] args) {
        ...
        try {
            if (settingsfile == null && in == null) {
                ...
                this.initialize(settingsfile, settingstexttoreplace, settingstexttoreplacewith, null, null, in, inexp, inexpplatform, inexpannot, gte, out, cis, trans, perm, textout, binout, snpfile, threads, nrEQTLsToOutput, eqtleffectstoregressout, null);
