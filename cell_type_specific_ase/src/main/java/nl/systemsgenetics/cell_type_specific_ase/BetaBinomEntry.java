 ...
 * Maybe there might be some better logic for this, but not sure.
 * 
 */
public class BetaBinomEntry {
   
    
    public BetaBinomEntry(String asLocations) throws FileNotFoundException, UnsupportedEncodingException, IOException{
        ...
        //TODO make filename a variable one can change from command line.
        ...
        while (true) {
            ...
            BetaBinomialTest results = new BetaBinomialTest(all_snp_data);
