...
import eqtlmappingpipeline.trityperconverter.ImputationTool;
import eqtlmappingpipeline.trityperconverter.ReverseTriTyperConverter;
import eqtlmappingpipeline.trityperconverter.TriTyperGenotypeConverter;
import eqtlmappingpipeline.util.UtilConsoleGUI;
import eqtlmappingpipeline.util.eQTLResultCompare;
...
public class EQTLMappingPipelineConsole {
    ...
    public void main(String[] args) {
        ...
        if (mode == null) {
            ...
            if (mode.equals("convertgt")) {
                TriTyperGenotypeConverter tc = new TriTyperGenotypeConverter(args);
            } else if (mode.equals("imputationtool")) {
                ImputationTool tool = new ImputationTool();
                ...
                eQTLResultCompare r = new eQTLResultCompare(args);
            } else if (mode.equals("revconvertgt")) {
                ReverseTriTyperConverter t = new ReverseTriTyperConverter(args);
    ...
    private void printUsage() {
        ...
        System.out.println("--mode convertgt\tConvert imputed genotypes\n"
                + "       metaqtl\t\tPerform QTL mapping on the dataset\n"
                ...
                + "       revconvertgt\tConvert TriTyperGenotypes back into Mach transposed\n"
