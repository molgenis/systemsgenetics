...
public class MachImputedTransposedDosageToTriTyper {
    ...
    public MachImputedTransposedDosageToTriTyper(String location, String outputloc, String headerfile) throws IOException {
        ...
        for(String file: fileList){
            ...
            String[] elems = g.readLineElemsReturnReference(TextFile.tab);
                ...
                while(elems != null){
                    ...
                    for(int i=7; i<elems.length; i++){
                        ...
                        try{
                            ...
                            System.err.println("Could not parse "+elems[i]+ " as double in file "+file+". It seems there is an error in the format of your genotype input!");
                            System.exit(-1);
                        }
                        dos = d_dosage;
                        if(d_dosage < 0.5){
                    ...
                    elems = g.readLineElemsReturnReference(TextFile.tab);
                    numsnps++;
                }
            } catch (Exception e){
