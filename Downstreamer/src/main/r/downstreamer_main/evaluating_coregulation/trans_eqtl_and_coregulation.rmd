...
pdf(width=8, height=4, file="output/plots/GenePrioritization_vs_sumchisqr_of_transeqtl_barplot.pdf", paper="a4")
theme.nature(p1) +  theme(axis.text.x = element_text(angle = 45, vjust = 1, hjust=1), legend.position = "none")
dev.off()


pdf(width=30, height=30, file="output/plots/GenePrioritization_vs_sumchisqr_of_transeqtl.pdf")
...
pdf(width=6, height=4.5, file="output/plots/GenePrioritizationEqtlGen_vs_trans_eqtl.pdf", paper = "a4")
