package mbqtl.junk;//package betaqtl.junk;
//
//import betaqtl.*;
...
//
//public class BetaQTL2 extends QTLAnalysis {
//
...
//
//	public BetaQTL2(String vcfFile, int chromosome, String linkfile, String snpLimitFile, String geneLimitFile, String snpGeneLimitFile, String geneExpressionDataFile, String geneAnnotationFile, String outfile) throws IOException {
...
////                ArrayList<UnpermutedResult> unpermutedResults = new ArrayList<>();
...
//						IntStream.range(-1, nrPermutations).parallel().forEach(permutation -> {
