...
Check if taking the inverse of the cholsky decomp is the same as first inverting then cholsky on that inverted matrix
```{r}
set.seed(12345)

m <- cor(matrix(rnorm(10000), nrow=100, ncol=100))
