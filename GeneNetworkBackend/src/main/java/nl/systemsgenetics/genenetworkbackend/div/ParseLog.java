...
public class ParseLog {
	...
	public static void main(String[] args) throws FileNotFoundException, IOException {
		...
		if (logFile.getName().endsWith(".gz")) {
			reader = new CSVReaderBuilder(new BufferedReader(new InputStreamReader((new GZIPInputStream(new FileInputStream(logFile)))))).withSkipLines(0).withCSVParser(parser).build();
		} else {
