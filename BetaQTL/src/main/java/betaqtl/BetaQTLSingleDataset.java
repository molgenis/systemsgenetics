...
public class BetaQTLSingleDataset extends QTLAnalysis {

    private int nrPermutations = 1000;
    private int cisWindow = 1000000;
    private long randomSeed = 123456789;

    public BetaQTLSingleDataset(String vcfFile, int chromosome, String linkfile, String geneLimitFile, String geneExpressionDataFile, String geneAnnotationFile, String outfile) throws IOException {
