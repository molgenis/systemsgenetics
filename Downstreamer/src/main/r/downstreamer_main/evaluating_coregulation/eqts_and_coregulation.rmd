...
pdf(width=3, height=3, file="output/plots/eqts_vs_max_coregulation_zscore.pdf", paper="a4")
...
eqts.plot <- function(pgs, trait) {
  ...
  write.table(df.plot[df.plot$x == gsub("\\n", " ", a),], file=paste0("output/plots/eqts_genes_", trait, ".tsv"), sep="\t", quote=F)
...
pdf(width=10, height=9, file="output/plots/eqts_vs_coregulation_per_trait.pdf")
grid.arrange(grobs=plots, ncol=4)
dev.off()


pdf(width=9, height=2.5, file="output/plots/eqts_vs_coregulation_significant_traits.pdf", paper="a4")
