...
# Hand grip strength
```{r}
h.dom <- read.depict2("~/Desktop/depict2/collaborations/biogen/hand_grip_strength/UKBB_hand_grip_strength_enrichtments_UKBB_dom_grip_abs_height_adj.xlsx")
h.nondom <- read.depict2("~/Desktop/depict2/collaborations/biogen/hand_grip_strength/UKBB_hand_grip_strength_enrichtments_UKBB_nondom_grip_abs_height_adj.xlsx")
