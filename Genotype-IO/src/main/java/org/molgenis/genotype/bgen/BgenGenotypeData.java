...
//		}
	...
	private double[][] readGenotypeProbabilities(
		...
		for (int sampleIndex = 0; sampleIndex < sampleCount; sampleIndex++) {
			...
			int numberOfCombinations = numberOfProbabilitiesForPloidyAlleleCombination(
	...
	public static int getIndexOfOrderedCombination(List<Integer> combination) {
		...
		for (int r = combination.size(); r > 0; r--) {
			...
			index += numberOfProbabilitiesForPloidyAlleleCombination(r, nMinOne);
		}
		return index;
	}
	 ...
	 */
	public static int numberOfProbabilitiesForPloidyAlleleCombination(int r, int nMinOne) {
