...
import eqtlmappingpipeline.interactionMeta.InteractionMeta;
...
import eqtlmappingpipeline.transCorrelationQtl.ExtractDataForPlots;
import eqtlmappingpipeline.transCorrelationQtl.MetaTransCorrelationQtl;
import eqtlmappingpipeline.transCorrelationQtl.transCorrelationQtl;
    ...
    public void main(String[] args) throws Exception {
        ...
        if (mode == null) {
            ...
            if (mode.equals("metaqtl")) {
                ...
                return;
            } else if (mode.equals("interactionMeta")) {
                InteractionMeta.runMeta();
                return;
            } else {
                printUsage();
            }
