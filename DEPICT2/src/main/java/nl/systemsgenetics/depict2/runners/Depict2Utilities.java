...
public class Depict2Utilities {
    ...
    /**
     * Utility to get the force normalized gene pvalues with tie resolving. Shares some duplicate code with
     * Depict2MainAnalysis.run2(). This can be cleaned up in future
     * @param options
     * @throws Exception
     */
