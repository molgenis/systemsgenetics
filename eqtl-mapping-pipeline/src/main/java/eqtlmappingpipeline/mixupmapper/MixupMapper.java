...
public class MixupMapper extends MetaQTL3 {
    ...
    public void run(String xmlSettingsFile, String texttoreplace, String texttoreplacewith,
        ...
        if (inputeQTLs == null) {
            ...
            out = initialOutputdir + "Cis-eQTLs/";
            initialize(xmlSettingsFile, texttoreplace, texttoreplacewith, null, null, ingt, inexp, inexpplatform, inexpannot, gte, out, cis, trans, perm, textout, binout, snpfile, threads, maxNrResults, regressouteqtls, snpprobecombofile);
            mapEQTLs();
