...
public class PathwayEnrichments {
	...
	public static HashMap<String, DoubleMatrixDataset<String, String>> performEnrichmentAnalysis(final DoubleMatrixDataset<String, String> genePvalues, final DoubleMatrixDataset<String, String> genePvaluesNullGwas, final DoubleMatrixDataset<String, String> geneWeights, final List<PathwayDatabase> pathwayDatabases, final String outputBasePath, HashSet<String> hlaGenesToExclude) {
		...
		HashMap<String, DoubleMatrixDataset<String, String>> enrichmentZscores = new HashMap<>(pathwayDatabases.size());
...
//					}
					...
					synchronized(enrichmentZscores){
						enrichmentZscores.put(pathwayDatabase.getName(), enrichment);
					}
