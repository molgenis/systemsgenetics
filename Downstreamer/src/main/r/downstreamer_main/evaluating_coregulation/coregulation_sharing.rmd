...
pdf(width=3, height=3, file="output/plots/GenePriortization_number_of_key_genes_vs_gwas_samplesize.pdf", paper="a4")
...
pdf(width=3, height=3, file="output/plots/GenePriortization_number_of_key_genes_vs_indep_gwas_hits.pdf", paper="a4")
...
# Regular scatterplot
pdf(width=3, height=3, file="output/plots/GenePriortization_degree_vs_max_key_gene_score.pdf", paper="a4")
...
# Hexbin
pdf(width=3.8, height=3, file="output/plots/GenePriortization_degree_vs_max_key_gene_score_hexbin.pdf", paper="a4")
p <- ggplot(data=df.plot, mapping=aes(x=x, y=y, col=is.key.gene)) + 
...
write.table(rownames(df.plot[df.plot$y < 750,]), row.names=F, col.names=F, quote=F, file="output/degree_st_750_genes.txt")
```
...
# Hexbin
pdf(width=3.8, height=3, file="output/plots/GenePvalues_degree_vs_max_key_gene_score_hexbin.pdf", paper="a4")
p <- ggplot(data=df.plot, mapping=aes(x=x, y=y, col=is.key.gene)) + 
  geom_hex(bins=50, col=NA) + 
  geom_smooth(method="lm", col="grey", fill="lightgrey") + 
...
pdf(width=8, height=3.5, file="output/plots/GenePriortization_number_of_keygenes_heatmap_ordered.pdf", paper="a4")
...
pdf(file="output/plots/GenePriortization_gene_sharing_25perc_edge_limit_bonfsig.pdf", width=9, height=5, paper="a4")
p2
dev.off()
```
...
pdf(width=5, height=2.5, file="output/plots/GenePriortization_percentage_of_shared_keygenes_per_class.pdf", paper="a4")
