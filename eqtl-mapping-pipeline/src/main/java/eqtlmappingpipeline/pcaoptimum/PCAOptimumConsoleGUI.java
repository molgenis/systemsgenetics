...
//                    System.out.println("ERROR: Please supply settings file (--settings settings.xml) or --in, --out and --inexp");
                    ...
                    p.initialize(settingsfile, settingstexttoreplace, settingstexttoreplacewith, null, null, in, inexp, inexpplatform, inexpannot, gte, out, cis, trans, perm, true, false, snpfile, threads, nrEQTLsToOutput, null, null, true, true, null);
                }
            }
        } catch (Exception e) {
            e.printStackTrace();
